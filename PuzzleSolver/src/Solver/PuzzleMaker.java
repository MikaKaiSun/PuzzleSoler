...
public class PuzzleMaker {
   ...
   * Search type as string (bfs or dfs or dfs2),
  ...
  public static void main(String[] args){
    ...
    try (Scanner scanner = new Scanner(System.in)) {
      ...
      if (size < 2 || !(search.equals("bfs") || search.equals("iddfs") || search.equals("dfs") ||
                        state.equals("random") || state.equals("unrandom"))) {
        throw new UnsupportedOperationException();
      }
      
      /* Checks if a custom state is entered. */
      if (state.equals("unrandom")) {
      ...
      if (search.equals("bfs")) {
      ...
      } else if(search.equals("iddfs")){ //Otherwise, user gets depth-first solving. 
        ...
        System.out.println(sol.solve(puzzle));
    	  ...
    	  /* Solve the puzzle with dfs. */
          PuzzleSolver sol = DFSSolver2.getInstance();
